 ...
 */
public interface LivenessTokenProvider extends Parcelable {

    /**
     * Requests a new verification token.
     * The token can be used to perform a user liveness detection with the BioID Webservice (BWS).
     *
     ...
     */
    LivenessToken requestLivenessToken(@NonNull Context ctx);
}
